...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{block}{Key points}
      \begin{itemize}
        ...
        \item Full size detector (ILD) to single prototype (CALICE) design
        \item ELog interface
      \end{itemize}
    \end{block}
    ~ \\
  ...
  \end{frame}
    ...
    \begin{frame}
      \frametitle{\secname}
      \framesubtitle{Example : SDHCAL DAQ interface}
      \begin{center}
 ...
 \begin{frame}
	...
	\begin{center}
         ...
         \uncover<2->{ \item Browser to build histograms selections to display }
       	 \uncover<5->{\item Search Function to refine selection } 
      \end{itemize}
