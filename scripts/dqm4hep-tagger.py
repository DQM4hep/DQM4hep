...
Tagging System for DQM4hep libraries. Make tags, collate release notes via command line or steering file
...
class DQM4hepTagger(object):
  ...
  def parseOptions(self):
    ...
    parser = argparse.ArgumentParser("Making DQM4hep Tags",
