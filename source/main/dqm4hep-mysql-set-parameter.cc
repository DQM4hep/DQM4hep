...
int main(int argc, char* argv[])
{
  ...
  TCLAP::ValueArg<std::string> parameterNameArg(
      "n"
      , "parameter-name"
      , "The parameter name"
      , true
  ...
  TCLAP::ValueArg<std::string> parameterValueArg(
      "v"
      , "parameter-value"
      , "The parameter value"
      , true
  ...
  try
  {
    ...
    THROW_RESULT_IF(STATUS_CODE_SUCCESS, !=, interface.connect(dbHostArg.getValue(), dbUserArg.getValue(), password, dbDbArg.getValue()));
