...
DQMStatisticsService::DQMStatisticsService(const std::string &baseServiceName)
{
...
DQMStatisticsService::~DQMStatisticsService()
{
...
void DQMStatisticsService::update(unsigned int statistics)
{
	...
	m_meanStats = static_cast<float>(std::accumulate(m_statsList.begin(), m_statsList.end(), 0, DQMStatisticsService::accumulateStats)) / static_cast<float>(m_statsList.size());
...
unsigned int DQMStatisticsService::accumulateStats(unsigned int sum, const DQMStats &stats)
{
