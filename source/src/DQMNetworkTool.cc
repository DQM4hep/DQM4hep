...
StringVector DQMNetworkTool::getEventCollectors()
{
	DimBrowser browser;
...
StringVector DQMNetworkTool::getMonitorElementCollectors()
{
	DimBrowser browser;
...
bool DQMNetworkTool::eventCollectorExists(const std::string &collectorName)
{
	// get the whole list
	StringVector eventCollectorList = DQMNetworkTool::getEventCollectors();
...
bool DQMNetworkTool::monitorElementCollectorExists(const std::string &collectorName)
{
	// get the whole list
	StringVector monitorElementCollectorList = DQMNetworkTool::getMonitorElementCollectors();
