...
namespace dqm4hep {
  ...
  namespace core {
    ...
    {
      m_pMonitorElementStorage = new Storage();
    }
    ...
    const std::string &MonitorElementManager::getCurrentDirectoryName() const
    {
    ...
    Path MonitorElementManager::getCurrentDirectoryFullPathName() const
    {
    ...
    StatusCode MonitorElementManager::getFullPathName(const std::string &subDirName, Path &fullPathName) const
    {
    ...
    StatusCode MonitorElementManager::getAllMonitorElements(MonitorElementPtrList &monitorElementList) const
    {
    ...
    StatusCode MonitorElementManager::getMonitorElement(const std::string &monitorElementName, MonitorElementPtr &monitorElement) const
    {
    ...
    StatusCode MonitorElementManager::getMonitorElement(const std::string &dirName, const std::string &monitorElementName, MonitorElementPtr &monitorElement) const
    {
    ...
    MonitorElementPtr MonitorElementManager::getMonitorElement(const std::string &monitorElementName) const
    {
    ...
    MonitorElementPtr MonitorElementManager::getMonitorElement(const std::string &dirName, const std::string &monitorElementName) const
    {
      MonitorElementPtr monitorElement = NULL;
    ...
    StatusCode MonitorElementManager::resetMonitorElements(ResetPolicy policy) const
    {
      ...
      for(MonitorElementPtrList::iterator iter = monitorElementList.begin(), endIter = monitorElementList.end() ;
          endIter != iter ; ++iter)
      {
        if(NULL == *iter)
          continue;
    ...
    StatusCode MonitorElementManager::resetMonitorElements() const
    {
      MonitorElementPtrList monitorElementList;
      RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, this->getAllMonitorElements(monitorElementList));
    ...
    StatusCode MonitorElementManager::getMonitorElementListToPublish(MonitorElementPtrList &monitorElementListToPublish) const
    {
      MonitorElementPtrList moduleElementList;
      RETURN_RESULT_IF( STATUS_CODE_SUCCESS, !=, this->getAllMonitorElements( moduleElementList ) );

      for( MonitorElementPtrList::const_iterator iter = moduleElementList.begin(), endIter = moduleElementList.end() ;
          endIter != iter ; ++iter )
      {
        if( (*iter)->isToPublish() )
    ...
    //StatusCode MonitorElementManager::archive(Archiver *pArchiver)
    //{
    //	if(NULL == pArchiver)
    //		return STATUS_CODE_INVALID_PTR;
    //
    //	// TODO implements this in Archiver
    ...
    Storage *MonitorElementManager::getStorage() const
    {
