/// \file GenericEventReader.cc
/*
 *
 * GenericEventReader.cc source template automatically generated by a class generator
...
namespace dqm4hep {
  ...
  namespace core {
    ...
    /**
     * @brief GenericEventReader class
     */
    class GenericEventReader : public EventReader {
    public:
      GenericEventReader() = default;
      ~GenericEventReader() override;
    ...
    GenericEventReader::~GenericEventReader() {
      /* nop */
    }

    //-------------------------------------------------------------------------------------------------

    core::StatusCode GenericEventReader::open(const std::string &fname) {
      if(not m_document.LoadFile(fname)) {
        dqm_error("GenericEventReader::open(): couldn't load xml file ['{0}', row: {1}, col: {2}] : {3}", fname,
    ...
    core::StatusCode GenericEventReader::skipNEvents(int nEvents) {
    ...
    core::StatusCode GenericEventReader::runInfo(core::Run &run) {
    ...
    core::StatusCode GenericEventReader::readNextEvent() {
    ...
    core::StatusCode GenericEventReader::close() {
      m_document.Clear();
      return STATUS_CODE_SUCCESS;
    }
    ...
    DQM_PLUGIN_DECL(GenericEventReader, "GenericEventReader");
  }
}
