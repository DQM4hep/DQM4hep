...
#ifndef DQMMODULEAPPLICATION_H
#define DQMMODULEAPPLICATION_H
...
/** DQMModuleApplication class
 */
class DQMModuleApplication : public DQMApplication
{
...
protected:
	 ...
	 */
	DQMMonitorElementManager *getMonitorElementManager() const;
