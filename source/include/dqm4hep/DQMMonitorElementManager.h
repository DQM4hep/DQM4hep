...
namespace dqm4hep {
  ...
  namespace core {
    ...
    public:
       ...
       */
      Path getCurrentDirectoryFullPathName() const;

      /** Get the full path name of the sub directory
       */
      StatusCode getFullPathName(const std::string &subDirName, Path &fullPathName) const;
    ...
    public:
       ...
       */
      StatusCode getAllMonitorElements(MonitorElementPtrList &monitorElementList) const;
    ...
    private:
      ...
      Storage                       *m_pMonitorElementStorage;
