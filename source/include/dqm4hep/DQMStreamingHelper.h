...
#ifndef DQMSTREAMINGHELPER_H
#define DQMSTREAMINGHELPER_H
...
public:
	...
	/**
	 */
	static xdrstream::Status read( xdrstream::IODevice *pDevice , DQMPublication &publication );

	/**
	 */
	static xdrstream::Status write( xdrstream::IODevice *pDevice , const DQMPublication &publication );

	/**
	 */
	static xdrstream::Status read( xdrstream::IODevice *pDevice , DQMMonitorElementInfoList &infoList );

	/**
	 */
	static xdrstream::Status write( xdrstream::IODevice *pDevice , const DQMMonitorElementInfoList &infoList );
};
...
template <typename T>
inline xdrstream::Status DQMStreamingHelper::read( xdrstream::IODevice *pDevice , T &stlContainer )
{
	uint32_t nRead = 0;
...
template <typename T>
inline xdrstream::Status DQMStreamingHelper::write( xdrstream::IODevice *pDevice , const T &stlContainer )
{
...
template <typename KeyType, typename ValueType>
inline xdrstream::Status DQMStreamingHelper::read( xdrstream::IODevice *pDevice , std::map<KeyType, ValueType> &stlContainer )
{
	uint32_t nRead = 0;
	XDR_STREAM( pDevice->read( & nRead ) )
...
template <typename KeyType, typename ValueType>
inline xdrstream::Status DQMStreamingHelper::write( xdrstream::IODevice *pDevice , const std::map<KeyType, ValueType> &stlContainer )
{
	uint32_t nWrite = stlContainer.size();
	XDR_STREAM( pDevice->write( & nWrite ) )
...
template <typename KeyType, typename ValueType>
inline xdrstream::Status DQMStreamingHelper::read( xdrstream::IODevice *pDevice , std::multimap<KeyType, ValueType> &stlContainer )
{
	uint32_t nRead = 0;
	XDR_STREAM( pDevice->read( & nRead ) )
...
template <typename KeyType, typename ValueType>
inline xdrstream::Status DQMStreamingHelper::write( xdrstream::IODevice *pDevice , const std::multimap<KeyType, ValueType> &stlContainer )
{
	uint32_t nWrite = stlContainer.size();
	XDR_STREAM( pDevice->write( & nWrite ) )
...
template <typename T>
inline xdrstream::Status DQMStreamingHelper::readStreamables( xdrstream::IODevice *pDevice, T &stlContainer )
{
	uint32_t nRead = 0;
	XDR_STREAM( pDevice->read( & nRead ) )
...
template <typename T>
inline xdrstream::Status DQMStreamingHelper::writeStreamables( xdrstream::IODevice *pDevice, const T &stlContainer )
{
	uint32_t nWrite = stlContainer.size();
	XDR_STREAM( pDevice->write( & nWrite ) )
...
template <typename KeyType, typename ValueType>
inline xdrstream::Status DQMStreamingHelper::readStreamables( xdrstream::IODevice *pDevice, std::map<KeyType, ValueType> &stlContainer )
{
	uint32_t nRead = 0;
	XDR_STREAM( pDevice->read( & nRead ) )
...
template <typename KeyType, typename ValueType>
inline xdrstream::Status DQMStreamingHelper::writeStreamables( xdrstream::IODevice *pDevice, const std::map<KeyType, ValueType> &stlContainer )
{
	uint32_t nWrite = stlContainer.size();
	XDR_STREAM( pDevice->write( & nWrite ) )
...
template <typename KeyType, typename ValueType>
inline xdrstream::Status DQMStreamingHelper::readStreamables( xdrstream::IODevice *pDevice, std::multimap<KeyType, ValueType> &stlContainer )
{
	uint32_t nRead = 0;
	XDR_STREAM( pDevice->read( & nRead ) )
...
template <typename KeyType, typename ValueType>
inline xdrstream::Status DQMStreamingHelper::writeStreamables( xdrstream::IODevice *pDevice, const std::multimap<KeyType, ValueType> &stlContainer )
{
	uint32_t nWrite = stlContainer.size();
	XDR_STREAM( pDevice->write( & nWrite ) )
