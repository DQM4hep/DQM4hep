...
#ifndef DQMLOCALFILEHANDLER_H
#define DQMLOCALFILEHANDLER_H
...
/** DQMLocalFileHandler class
 */
class DQMLocalFileHandler : public DQMFileHandler 
{
public:
	/** Constructor
	 */
