...
#ifndef DQMARCHIVER_H
#define DQMARCHIVER_H
...
public:
	 ...
	 */
	DQMArchiver(const std::string &archiveFileName, const std::string &openingMode = "RECREATE");
	 ...
	 */
	StatusCode archive(DQMStorage *pStorage, TDirectory *pDirectory);
