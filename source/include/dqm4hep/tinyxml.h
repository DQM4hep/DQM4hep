...
namespace dqm4hep {
  ...
  namespace core {
    ...
    public:
      ...
      const TiXmlNode *FirstChild(const char *_value)
      ...
      const TiXmlNode *LastChild(const char *_value)
...
// used to be public
    ...
    public:
       ...
       */
      const char *Parse(const char *p, TiXmlParsingData *prevData = nullptr,
    ...
    public:
      ...
      TiXmlElement *ToElement() const {
        return (((node != nullptr) && (node->ToElement() != nullptr)) ? node->ToElement() : nullptr);
      }
      /**	Return the handle as a TiXmlText. This may return null.
       */
      TiXmlText *ToText() const {
        return (((node != nullptr) && (node->ToText() != nullptr)) ? node->ToText() : nullptr);
      }
      /** Return the handle as a TiXmlUnknown. This may return null.
       */
      TiXmlUnknown *ToUnknown() const {
        return (((node != nullptr) && (node->ToUnknown() != nullptr)) ? node->ToUnknown() : nullptr);
      }
    ...
    public:
      ...
      void SetIndent(const char *_indent) {
        indent = _indent != nullptr ? _indent : "";
      }
      ...
      void SetLineBreak(const char *_lineBreak) {
        lineBreak = _lineBreak != nullptr ? _lineBreak : "";
      }
