...
\begin{figure}[p]
  \begin{center}
    \includegraphics[width=.8\linewidth]{figs/MaintInterfaceGUI.pdf}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.95\linewidth]{figs/DQM_SDHCAL_ECAL_HitMap6_I732891.pdf}
...
\IEEEtriggercmd{\enlargethispage{-15in}}
